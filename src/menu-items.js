                    ...
                    children: [
                        {
                            ...
                            title: 'Basic Table',
                            type: 'item',
                            url: `/dashboard/${params.userId}/tables/table-basic`,
                        },
                        {
                            id: 'dense-table',
                            title: 'Dense Tables',
                            type: 'item',
                            url: `/dashboard/${params.userId}/tables/dense-table`,
                            chip: {
                                label: 'Pro',
                                error: true,
                                size: 'small',
                        ...
                        },
                        {
                            ...
                            type: 'item',
                            url: `/dashboard/${params.userId}/tables/enhanced-table`,
                            chip: {
                                label: 'Pro',
                                error: true,
                                size: 'small',
                        ...
                        },
                        {
                            ...
                            title: 'Data Table',
                            type: 'item',
                            url: `/dashboard/${params.userId}/tables/data-table`,
                            chip: {
                                label: 'Pro',
                                error: true,
                                size: 'small',
                        ...
                        },
                        {
                            ...
                            title: 'Custom Table',
                            type: 'item',
                            url: `/dashboard/${params.userId}/tables/customized-table`,
                            chip: {
                                label: 'Pro',
                                error: true,
                                size: 'small',
                        ...
                        },
                        {
                            ...
                            title: 'Fixed Header',
                            type: 'item',
                            url: `/dashboard/${params.userId}/tables/sticky-header-table`,
                            chip: {
                                label: 'Pro',
                                error: true,
                                size: 'small',
                        ...
                        },
                        {
                            ...
                            type: 'item',
                            url: `/dashboard/${params.userId}/tables/collapse-table`,
                            chip: {
                                label: 'Pro',
                                error: true,
                                size: 'small',
